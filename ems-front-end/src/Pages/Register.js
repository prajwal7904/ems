          ...
          <div className='container mt-5'>
            ...
            <Card className='shadow mt-3 p-3'>
              <div className="text-center mb-3">
                <img className='rounded-circle border  p-1' width={'100px'} height={'100px'} src={preview ? preview : "https://www.vhv.rs/dpng/f/10-101667_person-icon-png.png"} alt="profile" />
              </div>
              <Form>
                <Row>
                  ...
                  <Form.Group className="col-lg-6 mb-2">
                    ...
                    <Form.Check required type={'radio'} label="Male" name="gender" value={'Male'} onChange={userDetail}
                    />
                    <Form.Check required type={'radio'} label="Female" name="gender" value={'Female'} onChange={userDetail}
                    />
                  </Form.Group>
                  <Form.Group className="col-lg-6 mb-2">
